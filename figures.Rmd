...
# }
# 
# plotly_hist2 <- plotly_hist(data)
# 
# htmlwidgets::saveWidget(plotly_hist2, "plotly_hist2.html", selfcontained = TRUE)
# 
...
# }
# 
# plotly_hist3 <- plotly_hist(data)
# 
# htmlwidgets::saveWidget(plotly_hist3, "plotly_hist3.html", selfcontained = TRUE)
```
...
ggsave("index_map.png", plot = map, width = 10, height = 7)
