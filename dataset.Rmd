...
<h1 style="text-align: center;">The Dataset</h1>
...
In some cases, a study will consist of multiple subtasks. In that case, each subtask gets its own row; these should be distinguished using the TaskID variable. (e.g., If two groups completed one study that consisted of three subtasks, then the study will be coded on six rows — 2 groups x 3 tasks.)</h5>
...
data <- data %>%
  select("Citation", "SpaceTask", "DependentMeasurePrimary", "FoR", "FoR_In_Task", "PerformanceIfRestrictedFoR", "StudyNumber", "TaskID", "Country", "SpecificLocation", "UrbanRural", "Language")
