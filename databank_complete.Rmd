...
<h5>For each paper, each task performed by a different cultural group is entered in ATLAS as its own row. A task consists of a different procedure or outcome variable. A group differs if they speak a different language, live in a different place, etc.  
